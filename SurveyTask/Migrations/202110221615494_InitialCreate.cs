                ...
                c => new
                    {
                        ...
                        PapandWors = c.Boolean(nullable: false),
                        ChickenStirfry = c.Boolean(nullable: false),
                        BeefStirFry = c.Boolean(nullable: false),
                        Other = c.Boolean(nullable: false),
                        firstQ = c.String(nullable: false),
                        SecQ = c.String(nullable: false),
                        thirdQ = c.String(nullable: false),
                        forthQ = c.String(nullable: false),
                        Answer = c.String(),
                    })
                .PrimaryKey(t => t.ID);
